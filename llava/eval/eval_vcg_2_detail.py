...
def main():
    ...
    for sample in new_pred_contents:
        ...
        question = sample["gpt_eval_score_detailed_orientation"]['Q']
        answer = sample["gpt_eval_score_detailed_orientation"]['A']
        pred = sample["gpt_eval_score_detailed_orientation"]['pred']
